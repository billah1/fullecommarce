                    ...
                    <div class="message-box">
                        <div class="success-container">
                            ...
                            <div class="confirm-green-box">
                                ...
                                <p>Your order #{{ $order->order_code }} has been sucessful!</p>
                                <p>Thank you for choosing Us. You will shortly receive a confirmation email.</p>
                            </div>

                            <br>
                            <a href="{{ route('home') }}" id="create-btn" class="btn btn-ouioui-secondary margin-left-5px">Back to shop</a>
                        </div>
                    </div>
                </div>
            </div>
