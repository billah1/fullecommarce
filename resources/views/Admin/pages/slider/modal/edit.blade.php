<div id="programmatically-show-hide-slide-over" class="p-5 modal">
    <div class="preview">
        <!-- BEGIN: Modal Content -->
        <div id="editModal" class="modal modal-slide-over" tabindex="-1"
             aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body p-10">
                        ...
                        <form id="sliderEditForm" enctype="multipart/form-data" method="post">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="buttons flex justify-between" style="margin-top: 20px;">
                                <a id="editModal-hide-modal" href="javascript:;"
